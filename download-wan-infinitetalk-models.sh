...
# 12. Qwen2.5 Tokenizer Files (Required for VibeVoice)
echo -e "${GREEN}Downloading Qwen2.5 Tokenizer files...${NC}"
...
# 13. VibeVoice-Large Model Files (18.7 GB total)
...
echo -e "  • VibeVoice Model: ${BASE_DIR}/vibevoice/VibeVoice-Large/"
echo -e "  • VibeVoice Tokenizer: ${BASE_DIR}/vibevoice/tokenizer/"
echo ""
